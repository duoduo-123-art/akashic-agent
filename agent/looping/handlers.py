...
class ConversationTurnHandler:
    ...
    def __init__(self, deps: ConversationTurnDeps, agent_core: "AgentCore | None" = None) -> None:
        self._llm = deps.llm
    ...
    def bind_agent_core(self, agent_core: "AgentCore") -> None:
        self._agent_core = agent_core
